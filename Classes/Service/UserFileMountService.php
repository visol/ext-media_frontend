<?php
namespace Visol\MediaFrontend\Service;
...
class UserFileMountService extends \TYPO3\CMS\Core\Resource\Service\UserFileMountService {
	 ...
	 *
	 * todo in EXT:fal_securedownload: https://review.typo3.org/#/c/27119/2
	 *
	...
	public function renderFlexFormSelectDropdown(&$PA, &$tceformsObj) {
		...
		if(is_array($flexform_data) && isset($flexform_data['data']['sDEF']['lDEF']['settings.storageUid']['vDEF'])) {
			$storageUid = (int)$flexform_data['data']['sDEF']['lDEF']['settings.storageUid']['vDEF'];
		}
